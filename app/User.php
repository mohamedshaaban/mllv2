...
use Spatie\Permission\Traits\HasRoles;use Illuminate\Database\Eloquent\SoftDeletes;
...
class User extends Authenticatable
{
    ...
    {
        return $this->orders()->where('comission_paid',1)->sum('comission') ;
    }
    public function getPendingComissionAttribute($key)
    {
        return $this->orders()->where('comission_paid','!=',1)->sum('comission') ;
    ...
    public function setCivilFrontIdAttribute($value)
    {
        $attribute_name = "civil_front_id";
        // or use your own disk, defined in config/filesystems.php
        $disk = config('backpack.base.root_disk_name');
        // destination path relative to the disk above
        $destination_path = "public/uploads/folder_1/folder_2";
    ...
    public function setCivilBackIdAttribute($value)
    {
        $attribute_name = "civil_back_id";
        // or use your own disk, defined in config/filesystems.php
        $disk = config('backpack.base.root_disk_name');
        // destination path relative to the disk above
        $destination_path = "public/uploads/folder_1/folder_2";
    ...
    public function setLicenseFrontIdAttribute($value)
    {
        $attribute_name = "license_front_id";
        // or use your own disk, defined in config/filesystems.php
        $disk = config('backpack.base.root_disk_name');
        // destination path relative to the disk above
        $destination_path = "public/uploads/folder_1/folder_2";
    ...
    public function setLicenseBackIdAttribute($value)
    {
        $attribute_name = "license_back_id";
        // or use your own disk, defined in config/filesystems.php
        $disk = config('backpack.base.root_disk_name');
        // destination path relative to the disk above
        $destination_path = "public/uploads/folder_1/folder_2";
