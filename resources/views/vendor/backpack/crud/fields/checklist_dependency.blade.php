              ...
              <div class="checkbox">
                  <label class="font-weight-normal">
                      <input type="checkbox"
                          ...
                          class = 'primary_list role_class_list'
...
@if ($crud->checkIfFieldIsFirstOfItsType($field))
    ...
    <script>
      ...
      var limit = 1;
      $('.role_class_list').on('change', function(evt) {

          if($(".role_class_list:checked").length > limit) {
              this.checked = false;
          }
          else
          {
              if($('.role_class_list:checked').val() == 4 )
              {
                  console.log($('.comission_type_class').prop('required','true'));
                  console.log($('.comission_class').attr('required','true'));
              }
              else
              {
                  $('.comission_class').removeAttr('required');
